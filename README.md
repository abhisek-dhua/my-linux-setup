...
| 9   | ⚡ NVM + Node            | Latest LTS Node + AI Tools (Cline, OpenCode, KiloCode) and Angular CLI                                                                                                                                    |
...
| 15  | 📥 Free Download Manager | FDM (.deb from SourceForge)                                                                                                                                                                               |
| 16  | 💬 Microsoft Teams       | _(prompted)_ Community-maintained Teams client with apt repo (auto-updates via apt)                                                                                                                       |
